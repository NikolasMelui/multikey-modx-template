(function() {
	function SpacePage(options) {
		...
		_.active = function() {
			...
			_.direction == 'down'
				? _.body.removeClass('body-active-' + _.prev + ' ' + body_active_class)
				: _.body.removeClass('body-active-' + _.next + ' ' + body_active_class);
			_.sect.removeClass('active active-sect active-next active-prev');
			_.direction == 'down'
				? _.sect.removeClass('active-' + _.prev + ' active-next')
				: _.sect.removeClass('active-' + _.next + ' active-prev');
